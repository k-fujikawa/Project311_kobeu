...
/**
 * Servlet implementation class SearchTwitterSVUyo
 */
@WebServlet("/SearchTwitterSVUyo")
public class SearchTwitterSVUyo extends HttpServlet {
  ...
  public SearchTwitterSVUyo() {
    ...
    try { // lucene関連
      ...
      searcher.setSimilarity(similarity); // 類似度の設定
        ...
        System.err.println("error: SearchTwitterSVUyoコンストラクタlucene関連");
        e.printStackTrace();
        System.exit(1);
      }
  ...
  public void displayNavbar(PrintWriter out, String queryStr) {
    ...
    out.println("<form action=\"./SearchTwitterSVUyo\" method=\"POST\">");
    out.println("<p>");
