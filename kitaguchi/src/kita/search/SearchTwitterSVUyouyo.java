...
/**
 * Servlet implementation class SearchTwitterSVUyouyo
 * 2012年のオープンキャンパスで使用したデモシステム<br>
 * 不要な処理があったりと、ソースコードが汚いですが、どうか大目に見てください・・・
 * <ul>
 *  <li>PATH_OF_INDEXにインデックスを指定</li>
 *  <li>一部の検索ワードに対して、正しく検索できないことがある。原因は不明</li>
 * </ul>
 */
...
public class SearchTwitterSVUyouyo extends HttpServlet {
  ...
  //public static final String PATH_OF_INDEX = "索引";
