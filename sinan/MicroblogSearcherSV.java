...
//	      displayJQuery(out, request);
	...
	protected void doPost(HttpServletRequest request,
		...
		// html開始タグ+head
	      displayHead(out, request);
	      displayBody(out, queryStr, listForSearch);
	      displayFooter(out);
...
//    	out.println("</span>");
    ...
    public void displayBody(PrintWriter out, String queryStr, List<String> searchList) {

    	out.println("<body>");
    	displayHeader(out);
    	out.println("<div class=\"contents\">");
    	displayNavbar(out,queryStr);
    	displayListArea(out, searchList);
    	out.println("</div>");
    	out.println("</div>");
	...
	public void displayListArea(PrintWriter out, List<String> searchList) {
...
//
//    public void displayJQuery(PrintWriter out, String indexId) {
//    	out.println("<script>");
//        out.println("$(function() {");
//
//        out.println("$(\'#" + indexId + "\').dblclick(function(){");
//
