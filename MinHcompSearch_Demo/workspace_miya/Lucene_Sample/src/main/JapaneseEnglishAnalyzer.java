...
/**
 * tokenStreamメソッドに英語のステミングを行う機能を追加
 * 
...
public class JapaneseEnglishAnalyzer extends JapaneseAnalyzer {
	 ...
	 * ==========<br>
	 * 使用例<br>
	 * analyzer = new JapaneseEnglishAnalyzer(Version.LUCENE_36,
	 * null,JapaneseTokenizer.Mode.SEARCH, stopwords, stoptags);<br>
	 * ==========<br>
	 * stopwordの設定例<br>
	 * // ストップワードの設定<br>
	 * public static void setStopWords() {<br>
	 * stopwords = new CharArraySet(Version.LUCENE_36,
	 * StandardAnalyzer.STOP_WORDS_SET, true);<br>
	 ...
	 *            ユーザ辞書
	 * @param mode
	 *            kuromojiのモード．SEARCHモード推奨
	 * @param stopwords
	 *            英語と日本語のストップワードを格納したSetを渡して下さい．
	 * @param stoptags
	 *            日本語のストップタグ
	 */
	public JapaneseEnglishAnalyzer(Version matchVersion,
			UserDictionary userDict, Mode mode, CharArraySet stopwords,
			Set<String> stoptags) {
